...
modules.define('shower.Location', [
    ...
    function Location(shower) {
        ...
        if (shower.options.get('enable_location')) {
            this._setupListeners();
            this._slideModeUrlParam = this._shower.options.get('mode_full_url_param');
            this._init();
        }
    }
    ...
    extend(Location.prototype, /** @lends shower.Location.prototype */{
        ...
        _onPopstate: function () {
            if (this._inited) {
                ...
                var shower = this._shower;
                var showerContainer = shower.container;
                ...
                var isSlideMode = this._isSlideMode(true);

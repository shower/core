...
modules.define('shower.Location', [
    'util.LocalStore',
    'util.extend'
], function (provide, LocalStore, extend) {
    ...
    function Location(shower) {
        ...
        var localStoreKey = shower.options.get('localstore_key') + '-shower.Location';
        this.state = new LocalStore(localStoreKey, {isSlideMode: false});
    ...
    extend(Location.prototype, /** @lends shower.Location.prototype */{
        ...
        _init: function () {
            ...
            if (currentSlideId !== '') {
                ...
                shower.go(typeof slideInfo.index !== 'undefined' ? slideInfo.index : 0);
            }
        },

...
class Shower {
    ...
    _initLiveRegion() {
        const lr = document.createElement('section');
        lr.className = 'region';
        lr.setAttribute('role', 'region');
        lr.setAttribute('aria-live', 'assertive');
        lr.setAttribute('aria-relevant', 'additions');
        lr.setAttribute('aria-label', 'Slide Content: Auto-updating');

...
modules.define('Shower', [
    ...
    Container, Player, Location, extend) {

    var DEFAULT_CONTAINER_SELECTOR = '.shower';
     ...
     * @param {string} [options.slides_selector = '.shower > SECTION'] Slide selector.
    ...
    function Shower(container, options) {
        ...
        this.options = new Options(extend({}, defaultShowerOptions, options));

        var containerElement = container || DEFAULT_CONTAINER_SELECTOR;
    ...
    extend(Shower.prototype, /** @lends Shower.prototype */{
        ...
        _parseSlides: function () {
            var slidesParser = this.options.get('slides_parser');
